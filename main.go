...
import (
	...
	magalixcomv1 "github.com/MagalixCorp/magalix-policy-agent/api/v1"
	"github.com/MagalixCorp/magalix-policy-agent/internal/admission"
	"github.com/MagalixCorp/magalix-policy-agent/internal/auditor"
	"github.com/MagalixCorp/magalix-policy-agent/internal/clients/kube"
	"github.com/MagalixCorp/magalix-policy-agent/internal/entities/k8s"
	"github.com/MagalixCorp/magalix-policy-agent/internal/policies/crd"
	"github.com/MagalixCorp/magalix-policy-agent/internal/sink/filesystem"
