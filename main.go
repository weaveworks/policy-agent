...
import (
	...
	"github.com/weaveworks/weave-policy-agent/configuration"
	"github.com/weaveworks/weave-policy-agent/controllers"
	"github.com/weaveworks/weave-policy-agent/internal/admission"
	"github.com/weaveworks/weave-policy-agent/internal/auditor"
	"github.com/weaveworks/weave-policy-agent/internal/clients/kube"
	"github.com/weaveworks/weave-policy-agent/internal/entities/k8s"
	"github.com/weaveworks/weave-policy-agent/internal/mutation"
	crd "github.com/weaveworks/weave-policy-agent/internal/policies"
	"github.com/weaveworks/weave-policy-agent/internal/sink/elastic"
	"github.com/weaveworks/weave-policy-agent/internal/sink/filesystem"
	flux_notification "github.com/weaveworks/weave-policy-agent/internal/sink/flux-notification"
	k8s_event "github.com/weaveworks/weave-policy-agent/internal/sink/k8s-event"
	"github.com/weaveworks/weave-policy-agent/internal/terraform"
	"github.com/weaveworks/weave-policy-agent/pkg/log"
